...
Simple steps to get template-sieb2sfdc-account-broadcast running
...
Once your app is all set and started, supposing you choose as domain name `template-sieb2sfdc-account-broadcast` to trigger the use case you just need to hit `http://template-sieb2sfdc-account-broadcast.cloudhub.io/synccontacts` and report will be sent to the emails configured.
